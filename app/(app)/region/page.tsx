...
export const metadata = {
  title: "Vùng miền · Map-VN",
  description: "Khám phá Việt Nam theo 3 vùng — Bắc, Trung, Nam.",
};
  ...
  return (
    <article className="pb-24">
      <section className="container pt-24 pb-12 md:pt-28">
        ...
        <Reveal delay={0.05}>
          <p className="mt-6 text-overline text-brand-600">VÙNG MIỀN</p>
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-text-muted">
            Từ núi rừng Tây Bắc đến đảo biệt lập miền Nam — mỗi vùng một câu chuyện.
          </p>
        </Reveal>
      </section>
        ...
        {regions.map((region, i) => (
          <Reveal key={region.key} delay={i * 0.05}>
            <header className="mb-6 flex items-end justify-between gap-4">
              ...
              >
                Tất cả tỉnh thành <ArrowRight size={16} />
              </Link>
            </header>
